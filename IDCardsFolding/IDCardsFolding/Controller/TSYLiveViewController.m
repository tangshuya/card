...
@interface TSYLiveViewController ()<UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, CollectionViewFlowLayoutDelagate>
...
@implementation TSYLiveViewController
...
// 测试数据
    NSArray *array = @[
               @{@"title":@"电卡",@"descTitle":@"东建世纪广场",@"numbers":@"000025653786231",@"createTime":@"2018.02.19"},
               @{@"title":@"老年卡",@"descTitle":@"东建世纪广场",@"numbers":@"000025653786231",@"createTime":@"2018.02.19"},
               @{@"title":@"煤气卡",@"descTitle":@"东建世纪广场",@"numbers":@"000025653786231",@"createTime":@"2018.02.19"},
               @{@"title":@"银行卡",@"descTitle":@"东建世纪广场",@"numbers":@"000025653786231",@"createTime":@"2018.02.19"},
                       ];
